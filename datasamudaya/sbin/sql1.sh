...
java $ADDOPENSMODULES $CLASSPATH $MEMCONFIGLOW $MEMCONFIGHIGH $GCCCONFIG $IPV4 -Djava.net.preferIPv4Stack=true $CLASSNAME -user arun -containerssql 3 -containercpu 2 -containermemory 2048 -sqlworkermode standalone
