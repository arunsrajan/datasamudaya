...
java $ADDOPENSMODULES $CLASSPATH $MEMCONFIGLOW $DEBUGCONFIG $MEMCONFIGHIGH $GCCCONFIG -Djava.net.preferIPv4Stack=true com.github.datasamudaya.tasks.scheduler.ApplicationSubmitter $@