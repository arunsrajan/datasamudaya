...
mvn -Dmaven.antrun.skip=true -Dmaven.test.skip.exec=true -Pmodules clean package
...
-Dmaven.antrun.skip=true -f pom.xml -Pmodules jacoco:report-aggregate sonar:sonar -Dsonar.projectKey=datasamudaya -Dsonar.projectName='datasamudaya' -Dsonar.host.url=http://localhost:9000 -Dsonar.token= -Dsonar.sources=pom.xml,src/main -Dsonar.test.exclusions=**src/test/**/*.java -Dsonar.language=Java
...
docker run --network datasamudaya -e "HDFS_CONF_dfs_namenode_datanode_registration_ip___hostname___check=false" -v "C:/DEVELOPMENT/dockershare:/opt/dockershare" -v "C:/DEVELOPMENT/dockershare/hive:/opt/datasamudaya/sbin/hive" -e "HDFS_CONF_dfs_datanode_data_dir=file:///opt/dockershare/data" --name datasamudayastandalonedn --hostname datasamudayastandalone --ip 172.30.0.10 -e ZKHOSTPORT=zoo:2181 -e TEHOST=172.30.0.10 -e TEPORT=10101 -e NODEPORT=12121 -e TSSHOST=172.30.0.10 --link namenode:namenode -e TSSPORT=22222 -e TSHOST=172.30.0.10 -e TSPORT=11111 -p 22222:22222 -p 22223:22223 -p 11111:11111 -p 11112:11112 -p 12123:12123 -p 11123:11123 -p 12124:12124 -e DPORT=*:4000 -p 4000:4000 --memory 20g --cpus 12 -e MEMCONFIGLOW=-Xms2g -e MEMCONFIGHIGH=-Xmx2g -e PODCIDRNODEMAPPINGENABLED=false -e NAMENODEURL=hdfs://namenode:9000 -e DATASAMUDAYA_HOME=/opt/datasamudaya -d arunsrajan/datasamudayastandalonedn

docker run --network datasamudaya -v "C:/DEVELOPMENT/dockershare:/opt/dockershare" -v "C:/DEVELOPMENT/dockershare/hive:/opt/datasamudaya/sbin/hive" --hostname dnte --link namenode:namenode --link zoo:zoo -e "CORE_CONF_fs_defaultFS=hdfs://namenode:9000" -e "HDFS_CONF_dfs_namenode_datanode_registration_ip___hostname___check=false" -e "HDFS_CONF_dfs_datanode_data_dir=file:///opt/dockershare/data1" --name datasamudayacontainerdn --ip 172.30.0.20 -e ZKHOSTPORT=zoo:2181 -e HOST=172.30.0.20 -e PORT=10101 -e NODEPORT=12121 -p 12121:12121 --memory 20g --cpus 12 -e MEMCONFIGLOW=-Xms2g -e MEMCONFIGHIGH=-Xmx2g -e PODCIDRNODEMAPPINGENABLED=false -e NAMENODEURL=hdfs://namenode:9000 -e DATASAMUDAYA_HOME=/opt/datasamudaya -d arunsrajan/datasamudayacontainerdn
