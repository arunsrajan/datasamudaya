 ...
 */
package com.github.datasamudaya.stream.transformation.examples;
...
public class StreamReducePairMultipleJoinsCoalesceReductionLocal implements Serializable, Pipeline {
	...
	private final Logger log = LogManager.getLogger(StreamReducePairMultipleJoinsCoalesceReductionLocal.class);
