...
import com.github.datasamudaya.stream.sql.dataframe.build.Expression;
import com.github.datasamudaya.stream.sql.dataframe.build.Literal;
import com.github.datasamudaya.stream.sql.dataframe.build.Operator;
import com.github.datasamudaya.stream.sql.dataframe.build.OrPredicate;

public class DataFrameAggregate implements Pipeline{
	private static final long serialVersionUID = -7389037644589597711L;
	private final Logger log = LogManager.getLogger(DataFrameAggregate.class);
