...
public class StreamReduceNormalInMemoryUserAllocation implements Serializable, Pipeline {
	private static final long serialVersionUID = -7001849661976107123L;
	private final Logger log = LogManager.getLogger(StreamReduceNormalInMemoryUserAllocation.class);
