...
public class StreamReduceNormalInMemorySortByAirlinesResourceDivided implements Serializable, Pipeline {
	...
	private final Logger log = LogManager.getLogger(StreamReduceNormalInMemorySortByAirlinesResourceDivided.class);
	...
	public void runPipeline(String[] args, PipelineConfig pipelineconfig) throws Exception {
		...
		pipelineconfig.setContaineralloc(DataSamudayaConstants.CONTAINER_ALLOC_DIVIDED);
