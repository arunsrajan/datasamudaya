...
/**
 * 
 * @author Arun Utility to get the intermediate and the final stage output from
...
public class RemoteDataFetcher {
	...
	private static final Logger log = LogManager.getLogger(RemoteDataFetcher.class);
	...
	public static void writerIntermediatePhaseOutputToDFS(Context serobj, String jobid, String filename)
			throws RemoteDataFetcherException {
		log.debug("Entered RemoteDataFetcher.writerIntermediatePhaseOutputToDFS");
		var configuration = new Configuration();
		configuration.set(DataSamudayaConstants.HDFS_DEFAULTFS, DataSamudayaProperties.get()
		...
		var jobpath = DataSamudayaProperties.get().getProperty(DataSamudayaConstants.HDFSNAMENODEURL,
				DataSamudayaConstants.HDFSNAMENODEURL_DEFAULT) + DataSamudayaConstants.FORWARD_SLASH
	...
	protected static void createFileMR(FileSystem hdfs, Path filepathurl, Context serobj)
			throws RemoteDataFetcherException {
	 ...
	 * @throws RemoteDataFetcherException
	 */
	protected static void createFile(FileSystem hdfs, Path filepathurl, Object serobj, Object config)
			throws RemoteDataFetcherException {
	 ...
	 * information in Task scheduler to HDFS
	 * 
	 * @param serobj
	 * @param dirtowrite
	 * @param filename
	 * @throws Throwable
	 */
	public static void writerYarnAppmasterServiceDataToDFS(Object serobj, String dirtowrite, String filename,
			Object config) throws RemoteDataFetcherException {
		...
		var jobpath = DataSamudayaProperties.get().getProperty(DataSamudayaConstants.HDFSNAMENODEURL,
				DataSamudayaConstants.HDFSNAMENODEURL_DEFAULT) + DataSamudayaConstants.FORWARD_SLASH
				+ FileSystemSupport.MDS + DataSamudayaConstants.FORWARD_SLASH + dirtowrite;
		var filepath = jobpath + DataSamudayaConstants.FORWARD_SLASH + filename;
		var jobpathurl = new Path(jobpath);
		var filepathurl = new Path(filepath);
		try (var hdfs = FileSystem.newInstance(new URI(DataSamudayaProperties.get()
	 ...
	 * information in Yarn App master from HDFS
	 * 
	 * @param dirtoread
	 * @param filename
	 * @return
	 * @throws Throwable
	 */
	public static Object readYarnAppmasterServiceDataFromDFS(String namenodeurl, String dirtoread, String filename)
			throws RemoteDataFetcherException {
		log.debug("Entered RemoteDataFetcher.readYarnAppmasterServiceDataFromDFS");
		var configuration = new Configuration();
		var path = namenodeurl + DataSamudayaConstants.FORWARD_SLASH + FileSystemSupport.MDS
				+ DataSamudayaConstants.FORWARD_SLASH + dirtoread + DataSamudayaConstants.FORWARD_SLASH + filename;
		try (var hdfs = FileSystem.newInstance(new URI(namenodeurl), configuration);
	 ...
	 * @throws Throwable
	 */
	public static Object readIntermediatePhaseOutputFromDFS(String jobid, String filename, boolean keys)
			throws RemoteDataFetcherException {
		log.debug("Entered RemoteDataFetcher.readIntermediatePhaseOutputFromDFS");
		var configuration = new Configuration();
		var path = DataSamudayaProperties.get().getProperty(DataSamudayaConstants.HDFSNAMENODEURL,
				DataSamudayaConstants.HDFSNAMENODEURL_DEFAULT) + DataSamudayaConstants.FORWARD_SLASH
				+ FileSystemSupport.MDS + DataSamudayaConstants.FORWARD_SLASH + jobid
	 ...
	 * @throws Throwable
	 */
	public static InputStream readIntermediatePhaseOutputFromDFS(String jobid, String filename, FileSystem hdfs)
			throws RemoteDataFetcherException {
		log.debug("Entered RemoteDataFetcher.readIntermediatePhaseOutputFromDFS");
		try {
			var path = DataSamudayaConstants.FORWARD_SLASH + FileSystemSupport.MDS + DataSamudayaConstants.FORWARD_SLASH
					+ jobid + DataSamudayaConstants.FORWARD_SLASH + filename;
			log.debug("Exiting RemoteDataFetcher.readIntermediatePhaseOutputFromDFS");
	 ...
	 * @throws Throwable
	 */
	public static InputStream readIntermediatePhaseOutputFromFS(String jobid, String filename)
			throws RemoteDataFetcherException {
		log.debug("Entered RemoteDataFetcher.readIntermediatePhaseOutputFromDFS");
		try {
			var path = DataSamudayaConstants.FORWARD_SLASH + FileSystemSupport.MDS + DataSamudayaConstants.FORWARD_SLASH
	 ...
	 * @throws Throwable
	 */
	public static void deleteIntermediatePhaseOutputFromDFS(String jobid) throws RemoteDataFetcherException {
		log.debug("Entered RemoteDataFetcher.deleteIntermediatePhaseOutputFromDFS");
		var configuration = new Configuration();
		try (var hdfs = FileSystem.newInstance(new URI(DataSamudayaProperties.get()
				.getProperty(DataSamudayaConstants.HDFSNAMENODEURL, DataSamudayaConstants.HDFSNAMENODEURL_DEFAULT)),
				configuration)) {
			hdfs.delete(new Path(DataSamudayaConstants.FORWARD_SLASH + FileSystemSupport.MDS
					+ DataSamudayaConstants.FORWARD_SLASH + jobid), true);
		} catch (Exception ioe) {
