 ...
 *
 */
public class ByteBufferPoolDirectOld {

	private static final Logger log = LoggerFactory.getLogger(ByteBufferPoolDirectOld.class);
	...
	private ByteBufferPoolDirectOld() {
	}
}
