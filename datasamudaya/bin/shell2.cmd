...
"%DATASAMUDAYA_JAVA_HOME%\bin\java" %MEMCONFIG% %ADDOPENSMODULES% %GCCONFIG% %CLASSPATH% -Djava.net.preferIPv4Stack=true com.github.datasamudaya.common.utils.JShellClient arun1
