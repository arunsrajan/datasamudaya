...
"%DATASAMUDAYA_JAVA_HOME%\bin\java" %MEMCONFIG% %ADDOPENSMODULES% %GCCONFIG% %DEBUGCONFIG% %CLASSPATH% -javaagent:../lib/dsagent-4.0.jar -Djava.net.preferIPv4Stack=true com.github.datasamudaya.stream.sql.SQLClient -user arun -containerssql 1 -containercpu 2 -containermemory 2048 -sqlworkermode ignite -driverlocation client
