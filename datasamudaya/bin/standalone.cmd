...
"%DATASAMUDAYA_JAVA_HOME%\bin\java" %MEMCONFIG% %ADDOPENSMODULES% %GCCONFIG% %CLASSPATH% -javaagent:../modules/dsagent-2.0.jar -Djava.net.preferIPv4Stack=true com.github.datasamudaya.tasks.scheduler.executor.standalone.EmbeddedSchedulersNodeLauncher %*
