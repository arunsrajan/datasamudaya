...
"%DATASAMUDAYA_JAVA_HOME%\bin\java" %MEMCONFIG% %ADDOPENSMODULES% %GCCONFIG% %DEBUGCONFIG% %CLASSPATH% -Djava.net.preferIPv4Stack=true com.github.datasamudaya.stream.pig.PigQueryClient -piguser arun -containerspig 1 -containercpu 2 -containermemory 2048 -pigworkermode jgroups
