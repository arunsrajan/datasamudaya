...
"%DATASAMUDAYA_JAVA_HOME%\bin\java" %MEMCONFIG% %ADDOPENSMODULES% %GCCONFIG% %DEBUGCONFIG% %CLASSPATH% -Djava.net.preferIPv4Stack=true com.github.datasamudaya.stream.pig.PigQueryClient -piguser arun -containerspig 3 -containercpu 3 -containermemory 3072 -drivercpu 3 -drivermemory 2048 -isdriverrequired true -driverlocation client -pigworkermode standalone
