...
public sealed class MapPair<I1, I2> extends AbstractPipeline permits MapValues {
	...
	protected <T, O1, O2> MapPair(AbstractPipeline parent,
			Object task) {
	 ...
	 */
	@SuppressWarnings({"unchecked"})
	public <T, T1, T2> MapPair<T, T> join(AbstractPipeline mapright, JoinPredicate<Tuple2<I1, T1>, Tuple2<I1, T2>> conditioninnerjoin) throws PipelineException {
