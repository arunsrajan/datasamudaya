 ...
 * @param <I1>
 */
public final class CsvStreamIgnite<I1> extends IgnitePipeline<I1> {

	@SuppressWarnings({"rawtypes"})
	public CsvStreamIgnite(IgnitePipeline root, CsvOptions csvOptions) {
		this.root = root;
	...
	@SuppressWarnings({"rawtypes"})
	public CsvStreamIgnite(IgnitePipeline root, PeekConsumer peekconsumer) {
		this.root = root;
